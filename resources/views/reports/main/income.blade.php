...
@section('page')
    সকল অর্থ কালেকশন রিপোর্ট
@stop

@section('breadcrumb')
	@include('templates._partials.breadcrumb', ['title' => ' সকল অর্থ কালেকশন রিপোর্ট ', 'links' => [
	    'রিপোর্ট' => 'report',
	    ' কালেকশন রিপোর্ট ' => 'report/income'
	]])
@stop
...
@section('content')
    <div class="row">
        <div class="col-md-8">
            <h4>  সকল অর্থ কালেকশন রিপোর্ট । সিজনের নাম :
                {{ $season['name'] }}
    ...
    <div class="table-responsive">
        <table class="table table-bordered dataTable">
            ...
            @if(count($collections))
                ...
                @foreach($collections as $collection)
                    <tr>
                        ...
                        <td>{{ $collection->schedule->business->name }}</td>
            ...
            @else
                <tr>
                    <td colspan="7" class="text-center"> এই প্রকল্পে কোন অর্থ কালেকশন নেই । </td>
                </tr>
            @endif
            </tbody>
        </table>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#select-season").on('change', function(){
                ...
                window.location.href = "{{ url('report/income') }}" + "/" + id;
            });

            @if(count($collections))
            var title = "সকল অর্থ কালেকশন রিপোর্ট । সিজনের নাম : {{ $season['name'] }}";
            $('.dataTable').dataTable({
                "bSort" : false,
                dom: 'Brtp<"bottom"l>',
